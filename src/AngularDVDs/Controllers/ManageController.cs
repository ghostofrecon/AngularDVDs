...
using AngularDVDs.Models;
using AngularDVDs.Models.ManageViewModels;
using AngularDVDs.Services;
...
namespace AngularDVDs.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<IActionResult> VerifyPhoneNumber(string phoneNumber)
        {
            var code =
                await
                this._userManager.GenerateChangePhoneNumberTokenAsync(await this.GetCurrentUserAsync(), phoneNumber);
